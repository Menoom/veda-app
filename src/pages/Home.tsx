      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-earth-700 mb-10 max-w-3xl mx-auto leading-relaxed">
            Embark on a transformative journey through the sacred texts that have guided humanity for millennia. 
            Discover the timeless teachings of the Vedas, beautifully presented for today's spiritual explorer.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="font-serif text-2xl font-bold text-primary mb-2">1,000+ Verses</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-serif text-2xl font-bold text-primary mb-2">4 Vedas</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="font-serif text-2xl font-bold text-primary mb-2">10,000+ Seekers</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-earth-600 max-w-3xl mx-auto">
              Follow the sacred path through the ancient wisdom traditions. Each step reveals deeper insights 
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-white/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-earth-600 max-w-3xl mx-auto">
              Dive deeper into the vast ocean of Vedic literature. From ancient manuscripts 
              to philosophical treatises, discover the treasures of spiritual wisdom.
            </p>
          </div>
          <ResourceCards />
        </div>
