      ...
      settings: [
        {
          ...
          description:
            "Receive updates about new content and community activities",
          type: "toggle",
        },
        {
          key: "dailyReminders",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-earth-600 text-lg">
            Customize your Veda reading experience
          </p>
        </div>
        ...
        <div className="space-y-8">
          {settingsGroups.map((group) => {
            ...
            return (
              <div
                key={group.title}
                className="bg-glass rounded-2xl shadow-xl overflow-hidden"
              >
