        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-glass rounded-xl p-6 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-earth-500 bg-gold-100 px-2 py-1 rounded-full">
                This Week
              </span>
            </div>
          ...
          <div className="bg-glass rounded-xl p-6 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-earth-500 bg-sage-100 px-2 py-1 rounded-full">
                This Week
              </span>
            </div>
          ...
          <div className="bg-glass rounded-xl p-6 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-earth-500 bg-maroon-100 px-2 py-1 rounded-full">
                Goal
              </span>
            </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2 mb-1">
                          <span
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getVedaColor(
                              session.veda
                            )}`}
                          >
                            {session.veda}
                        ...
                        <div className="text-sm text-earth-600">
                          {session.duration} minutes • {session.verses} verses •{" "}
                ...
                <div className="space-y-4">
                  {achievements.map((achievement, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-start space-x-3 p-4 rounded-xl bg-white/50"
                      >
                        <div
                          className={`w-10 h-10 ${
