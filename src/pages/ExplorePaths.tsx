...
import { Search, Filter, BookOpen, Users, Star, Clock, ArrowRight, Compass } from 'lucide-react';
  ...
  const explorationPaths = [
    {
      ...
      description: 'Explore the intricate rituals and ceremonies of Vedic fire sacrifices, understanding their symbolic meaning and spiritual significance.',
    ...
    },
    {
      ...
      description: 'Learn the ancient art of Vedic chanting and discover how sound vibrations can transform consciousness and promote spiritual growth.',
      difficulty: 'Beginner',
      duration: '4 weeks',
      participants: 567,
      rating: 4.9,
      category: 'Music & Chanting',
      image: 'https://images.pexels.com/photos/6963070/pexels-photo-6963070.jpeg',
    ...
    },
    {
      ...
      description: 'Journey through the cosmic hymns that reveal the Vedic understanding of creation, divine forces, and the nature of reality.',
      difficulty: 'Advanced',
      duration: '8 weeks',
      participants: 189,
      rating: 4.7,
    ...
    },
    {
      ...
      description: 'Discover the practical aspects of Vedic knowledge including healing practices, protective prayers, and daily life applications.',
      difficulty: 'Beginner',
      duration: '5 weeks',
      participants: 423,
      rating: 4.6,
    ...
    },
    {
      ...
      description: 'Explore the philosophical foundations of meditation and self-realization through the profound teachings of the Upanishads.',
      difficulty: 'Advanced',
      duration: '10 weeks',
      participants: 145,
      rating: 4.9,
    ...
    },
    {
      ...
      description: 'Build a strong foundation in Sanskrit to better understand and appreciate the original Vedic texts in their authentic form.',
      difficulty: 'Beginner',
      duration: '12 weeks',
      participants: 789,
      rating: 4.5,
      category: 'Language',
      image: 'https://images.pexels.com/photos/159832/book-read-reading-books-159832.jpeg',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-xl text-earth-600 max-w-3xl mx-auto">
            Discover structured learning journeys through different aspects of Vedic wisdom. 
            Choose your path based on your interests and spiritual goals.
          </p>
        </div>
        ...
        <div className="mb-6">
          <p className="text-earth-600">
            Showing {filteredPaths.length} of {explorationPaths.length} learning paths
          </p>
        </div>
          ...
          {filteredPaths.map((path) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium text-white ${colors.bg}`}>
                        {path.category}
                      </span>
                ...
                <div className="p-6">
                  <div className="mb-4">
                    <h3 className="font-serif text-xl font-bold text-primary mb-1">{path.title}</h3>
                    <p className={`text-sm font-medium ${colors.text} mb-3`}>{path.subtitle}</p>
                    <p className="text-earth-600 text-sm leading-relaxed">{path.description}</p>
                  </div>
                  ...
                  {/* Action Button */}
                  <button className={`w-full flex items-center justify-center space-x-2 py-3 px-4 rounded-xl ${colors.text} border-2 ${colors.border} ${colors.hover} hover:bg-current hover:text-white transition-all duration-200 group`}>
        ...
        {filteredPaths.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="font-serif text-2xl font-bold text-primary mb-2">No paths found</h3>
            <p className="text-earth-600 mb-6">Try adjusting your search criteria or browse all available paths.</p>
            <button
              onClick={() => {
                setSearchTerm('');
