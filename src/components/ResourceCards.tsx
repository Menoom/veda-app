  ...
  const resources = [
    {
      title: "Manuscripts",
      description:
        "Ancient palm leaf manuscripts and sacred texts preserved through centuries",
      icon: FileText,
      image:
    ...
    },
    {
      title: "Samhitas",
      description:
        "Complete collections of hymns, mantras, and ritual formulas",
      icon: Scroll,
      image:
          ...
          >
            ...
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <div
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm bg-gradient-to-r ${colors.from} ${colors.to}`}
                >
            ...
            <div className="p-6">
              <div className="flex items-center mb-3">
                <div
                  className={`w-12 h-12 ${colors.bg} rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform`}
                >
              ...
              <button
                className={`w-full flex items-center justify-center space-x-2 py-3 px-4 rounded-xl ${colors.text} border-2 border-current hover:bg-current hover:text-white transition-all duration-200 group-hover:scale-105`}
              >
